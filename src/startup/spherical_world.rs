...
fn setup(
    ...
    // top
    setup_face(
        |i, j, step| Vec3::new(-RADIUS + i as f32 * step, RADIUS, -RADIUS + j as f32 * step),
        false,
        &mut commands,
        &mut meshes,
        &mut materials,
    ...
    // back
    setup_face(
        |i, j, step| Vec3::new(-RADIUS + i as f32 * step, -RADIUS + j as f32 * step, RADIUS),
        true,
        &mut commands,
        &mut meshes,
        &mut materials,
    ...
    // right
    setup_face(
        |i, j, step| Vec3::new(RADIUS, -RADIUS + j as f32 * step, -RADIUS + i as f32 * step),
        false,
        &mut commands,
        &mut meshes,
        &mut materials,
